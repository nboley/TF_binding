...
cmd:option('-training_file', 'train.mat', 'training matfile')
cmd:option('-validation_file', 'valid.mat', 'validation matfile')
cmd:option('-training_size', 1, 'size of training data')
cmd:option('-validation_size', 1, 'size of validation data')
cmd:text()
